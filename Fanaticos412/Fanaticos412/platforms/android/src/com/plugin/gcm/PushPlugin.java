...
public class PushPlugin extends CordovaPlugin {
    ...
    public static final String PUSH_PREFS_NAME = "Fanaticos412PushPrefsFile";
  ...
  //extra functions
  	public static void registerDeviceOnServer(Context context, String regId) {
  	    ...
  	    //Log.v(TAG, "REGID: " + regId);
  	    //HttpPost httppost = new HttpPost("http://kraken.hecticus.com/storefront/wsext/mobile_push/fanaticos412/activatePushClient.php");
  	    HttpPost httppost = new HttpPost("http://10.0.3.142/kraken/storefront/wsext/mobile_push/fanaticos412/activatePushClient.php");
  	    ...
  	    try {
			...
			Log.v(TAG, "REGID: " + regId+" OLD: "+storedRegId);
  	        ...
  	        nameValuePairs.add(new BasicNameValuePair("token", "FANATICOS412"));
