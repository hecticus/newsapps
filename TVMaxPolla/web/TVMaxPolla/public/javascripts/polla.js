	...
	$.fCompare = function(_groupTeams,_eval) {
		...
		return {firts:afirts,second:asecond};
				...
				$(document).on('click','.back', function() {
					...
					var _group = $('.row.phase[data-phase="'+_phase+'"] .row.group:visible').data('group');
					
					_group = _group - 2;
	


					if ((_phase == 1) && (_group >= 0))  {


						$('.menu.group[data-group]').removeClass('on');
						$('.menu.group[data-group="'+arrPhase[0].group[_group].id+'"]').addClass('on');
						$('.row.phase[data-phase="'+_phase+'"] .row.group').addClass('hidden');
						$('.row.phase[data-phase="'+_phase+'"] .row.group[data-group="'+arrPhase[0].group[_group].id+'"]').removeClass('hidden');
						...
						if (_phase == 1) {
							...
							$('.row.phase[data-phase="1"] .row.group').addClass('hidden');
							$('.row.phase[data-phase="1"] .row.group[data-group="1"]').removeClass('hidden');	
						}
				...
				$(document).on('click','.next', function() {
					...
					if ((_phase == 1) && (_group <= 7))  {
						$('.menu.group[data-group]').removeClass('on');
						$('.menu.group[data-group="'+arrPhase[0].group[_group].id+'"]').addClass('on');
						$('.menu.group[data-group="'+arrPhase[0].group[_group].id+'"]').removeClass('hidden');
						$('.row.phase[data-phase="'+_phase+'"] .row.group').addClass('hidden');
						$('.row.phase[data-phase="'+_phase+'"] .row.group[data-group="'+arrPhase[0].group[_group].id+'"]').removeClass('hidden');							
					} else if (_phase <= 5) {
						
						$('.menu.phase').removeClass('on');
						$('.menu.phase[data-phase="'+arrPhase[_phase].id+'"]').addClass('on');
						$('.row.phase').addClass('hidden');
						$('.row.phase[data-phase="'+arrPhase[_phase].id+'"]').removeClass('hidden');
						$('.row.phase[data-phase="'+arrPhase[_phase].id+'"] .group').removeClass('hidden');
