  ...
  ui: function(params, cb) {
    ...
    if (FB._nativeInterface) {
        switch (params.method) {
            case 'auth.login':
                FB._nativeInterface.login(params, cb, function(e) {alert('Facebook Connect plugin fail on login!' + e);});
                break;
...
FB.provide('', {
  ...
  init: function(options) {
    ...
    if (FB._nativeInterface) {
      FB._nativeInterface.init(FB._apiKey, function(e) {alert('Facebook Connect plugin fail on init!');});
    }
