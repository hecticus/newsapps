 ...
 */
angular.module('core').factory('Upstream', Upstream);

Upstream.$injector = ['$http', '$q', 'Client', 'Moment', 'CordovaDevice', 'App'];
function Upstream($http, $q, Client, Moment, CordovaDevice, App) {
