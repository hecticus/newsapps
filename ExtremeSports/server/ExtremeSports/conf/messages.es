...
playauthenticate.password.verify_signup.subject=Memepedia: Complete su registro
playauthenticate.password.verify_email.subject=Memepedia: Confirme su dirección de email
playauthenticate.password.reset_email.subject=Memepedia: Cómo restablecer su contraseña
...
playauthenticate.verify.email.requirement=Antes de usar Memepedia, debe validar su email.
...
playauthenticate.oauth.access.denied.explanation=Si quiere usar Memepedia con OAuth, debe aceptar la conexión.
...
athletes.list.filter.name=Filtrar por nombre del Atleta...
athletes.list.new=Agregar nueva Atleta

athletes.create=Crear Atleta
athletes.edit=Editar Atleta
athletes.info=Informacion del Atleta

athletes.category=Categoria
athletes.category.plural=Categorias
athletes.category.remove=Eliminar esta categoria
athletes.category.add=Agregar Categoria

athletes.socialnetwork=Red Social
athletes.socialnetwork.plural=Redes Sociales
athletes.socialnetwork.remove=Eliminar esta Red Social
athletes.socialnetwork.add=Agregar Red Social
athletes.socialnetwork.link=Enlace

athletes.name=Nombre
athletes.name.help=Inserte un nombre valido

athletes.image=Imagen
athletes.image.file=Archivo

athletes.submit.create=Crear esta Atleta
athletes.submit.update=Actualizar esta Atleta
athletes.submit.delete=Eliminar esta Atleta

athletes.java.created= El tema {0} ha sido creada!
athletes.java.updated= El tema {0} ha sido actualizada!
athletes.java.deleted= El tema {0} ha sido eliminada!
...
post.athlete=Atleta
post.athlete.remove=Eliminar este Atleta
post.athlete.add=Agregar Atleta
post.athletes=Atletas

post.category=Categoria
post.category.plural=Categorias
post.category.remove=Eliminar esta categoria
post.category.add=Agregar Categoria
