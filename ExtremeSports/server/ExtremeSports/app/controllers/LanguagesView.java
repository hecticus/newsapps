...
public class LanguagesView extends HecticusController {
    ...
    public static Result edit(Integer id) {
        Language objBanner = Language.getByID(id);
        Form<Language> filledForm = LanguageViewForm.fill(Language.getByID(id));
    ...
    public static Result sort(String ids) {
        ...
        for (int i=0; i<aids.length; i++) {
            Language oPost = Language.getByID(Integer.parseInt(aids[i]));
            //oWoman.setSort(i);
            oPost.save();
        }
