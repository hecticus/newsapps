	...
	_oAjax = _fGetAjaxJson(_url + '/garotas/v1/posts/get/client/category/' + _jParameters.client + '/' + _jParameters.category);
	...
	var _fTouchPlus =  function(_this) {
		...
		_oAjax = _fGetAjaxJsonAsync(_url + '/garotas/v1/posts/get/client/down/category/' + _this.data('direction') + '/' + _jParameters.client + '/' + $('div.post').last().data('value') + '/' + _jParameters.woman);		
		if (_oAjax) {
			_oAjax.done(function(_json) {				
